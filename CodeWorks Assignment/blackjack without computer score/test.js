...
$( function () {
    ...
    function fakeComputerCard(){
         blankCardDiv = $('<div>', { class: "blankCard",
                                });
        
        $('#blankCardHere').append(blankCardDiv);
    }
    ...
    function startGame(){
        ...
        //Inorder for computer to only draw one shown card
    ...
    function stand(){
        ...
        //computer turn
        document.getElementById("blankCardHere").innerHTML = ""; //This clears the blank card out
        while(scores[1]<17){
            hit(false);
            $('#computerScore').html(scores[1]); 
            console.log(scores)
